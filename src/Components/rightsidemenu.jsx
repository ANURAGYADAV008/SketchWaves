...
import React, { useState } from "react";
import { LayoutDashboard, LogOut, ChevronRight, User, Settings } from "lucide-react";
    ...
    <>
      ...
      <div className="rb-wrap">
        ...
        <div className="rb-profile">
          ...
          <div>
            <div className="rb-name">My Account</div>
            <div className="rb-email">user@sketchwave.io</div>
          </div>
        </div>
        ...
        <div className="rb-menu">
          ...
          >
            <LayoutDashboard size={15} />
            My Canvas
            <ChevronRight size={13} className="rb-chevron" onClick={navigate("/dashboard")}/>
          </button>
        </div>
